...
let col_info = document.querySelector('.col.name h3').innerHTML
let lic_info = document.querySelector('.col.lic h3').innerHTML
let track_info = document.querySelector('.col.track h3').innerHTML
...
const openEdit = (element) => {
  ...
  edit.innerHTML = `
    <div class="top">
              ...
              <input type="text" id="tariff_title" placeholder="Название тарифа" />
              <input type="text" id="tariff_lic" oninput="validateInput(this)" />
              <input type="text" id="tariff_track" oninput="validateInput(this)" />
              <div class="price">
                <p class="BodyM">0₸</p>
              </div>
            </div>
            <div class="bot">
              <input type="button" value="Закрыть" class="btn dark" onclick="modalClose()" />
              <input type="button" value="Изменить" class="btn main" onclick="addTariff()" />
            </div>
    `;
